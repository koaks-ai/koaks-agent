...
class SubagentToolTest {
    ...
    @Test
    fun appendsReadOnlyFileGuardToChildPrompt() =
        runBlocking {
    ...
    @Test
    fun failedChildUsesTheExplicitToolErrorChannel() =
        runBlocking {
            val child =
                childAgent(
    ...
    @Test
    fun invalidSubagentInputUsesTheExplicitToolErrorChannel() =
        runBlocking {
    ...
    @Test
    fun terminatedChildUsesTheExplicitToolErrorChannelWithPartialOutput() =
        runBlocking {
            val child =
                agent {
                    id = "koaks-agent-subagent"
    ...
    @Test
    fun identicalDescriptionsReuseOneAgentDefinitionWithoutIdConflict() =
        runBlocking {
    ...
    @Test
    fun fiveSubagentsRunInParallelAndOneFailureDoesNotCancelTheOthers() =
        runBlocking {
    ...
    private fun parentAgent(
        id: String,
        subagent: SubagentTool,
        calls: List<ToolCall>,
    ): Agent {
        val toolStep =
            buildList<ModelEvent> {
    ...
    private fun successEvents(text: String): List<ModelEvent> = listOf(ModelEvent.TextDelta(text), ModelEvent.Completed(Usage.ZERO))
