...
internal object NativeFileSystem {
    ...
    public fun canonicalPath(path: String): String? = NativePathResolver.canonicalPath(path)
    ...
    public fun removePath(path: String): Boolean = remove(path) == 0

    public fun timestamp(): Long = time(null).toLong()
