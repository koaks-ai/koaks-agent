...
internal expect object PlatformConsole {
 ...
 * TUI views free of direct `print`/`fflush` calls, and gives
...
internal class StdoutOutput : LiveLinesOutput {
    ...
    override fun write(text: String) = PlatformConsole.write(text)

    override fun writeLine(text: String) = PlatformConsole.writeLine(text)
    ...
    override fun flush() = PlatformConsole.flush()
}
