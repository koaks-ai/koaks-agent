...
internal object StdinLineReader : LineReader {
    ...
    override fun readLine(request: LineReadRequest): String? {
        if (!PlatformTerminalInput.enterRawMode()) return readLine()
        ...
        try {
            ...
            while (true) {
                val key = PlatformTerminalInput.readKey()
            ...
            try {
                ...
                PlatformTerminalInput.leaveRawMode()
            }
        }
    }
}
...
internal expect object PlatformTerminalInput {
