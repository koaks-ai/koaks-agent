...
import org.koaks.agent.agent.AgentFactory
...
internal class SubagentTool(
    private val subagent: Agent,
) : Tool<SubagentInput> {
    constructor(config: AgentConfig) : this(AgentFactory.buildSubagent(config))
    ...
    private fun formatResult(description: String, result: AgentResult): String {
